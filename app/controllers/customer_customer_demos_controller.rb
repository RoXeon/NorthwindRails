class CustomerCustomerDemosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @customer_customer_demo.save
        ...
        format.json { render action: 'show', status: :created, location: @customer_customer_demo }
      else
  ...
  private
    ...
    def customer_customer_demo_params
      params.require(:customer_customer_demo).permit(:customer_id, :customer_demographic_id)
    end
end
